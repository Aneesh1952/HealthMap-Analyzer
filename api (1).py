...
@app.route('/')
def home():
    return "Welcome to the HealthMap Analyzer API! Use the /api/health to check the working status, /api/generate-map and /api/maps/<filename>  endpoints.   While uploading the CSV file, make sure to upload the csv file with Longitude, Latitude and a health_metric"
